...
<!-- Video section -->
    <section class="section-default section-video trigger-circle pb-0">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10 offset-md-1">
                    <iframe width="100%" height="615" style="max-width:100%" src="https://www.youtube.com/embed/A1LZeZp5qtE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" no-controls allowfullscreen></iframe>
                </div>
            </div>
        </div>
                        ...
                        <div class="grid-gap wow animate__animated animate__fadeInLeft">
                            ...
                            <div class="box-padding box-border d-flex align-items-center box-shadow">
                                ...
                                <div>
                                    ...
                                    <div class="bar"></div>    
                                    <small><b>87%</b> das vagas já foram preenchidas</small>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-12 col-md-5 offset-md-1 order-0">
                    ...
                    <h2 class="text-white wow animate__animated animate__fadeIn animate__fast">A mentoria irá te transformar em um <span class="gradient-text">Broker de tesouraria</span></h2>
                    <p class="my-3 wow animate__animated animate__fadeIn animate__slow">Você vai ter uma visão geral do que é o High-Frequency Trading(HFT), incluindo sua definição, história e importância nos mercados financeiros modernos.</p>
                    <p>Vou te ensinar como analisar dados de mercado em tempo real e identificar padrões e tendências que possam ser explorados para obter lucro.</p>
                    <div class="howitworks-wrapper">
                        <div class="howitworks-item wow animate__animated animate__fadeInUp">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="bi bi-check-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/></svg>
                            <b>Mentoria<br />100% presencial</b>
                        </div>
                        <div class="howitworks-item wow animate__animated animate__fadeInUp">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="bi bi-check-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/></svg>
                            <b>3 Dias<br />de aprendizado</b>
                        </div>
                        <div class="howitworks-item wow animate__animated animate__fadeInUp">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="bi bi-check-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/></svg>
                            <b>Disponível<br />somente para alunos</b>
                        </div>
                        <div class="howitworks-item wow animate__animated animate__fadeInUp">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="bi bi-check-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/></svg>
                            <b>Acesso total<br />ao mentor</b>
                        </div>
                    </div>                    
                </div>
            </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-12 col-md-6  wow animate__animated animate__fadeInRight">
                    <div class="owl-carousel owl-theme owl-for-who">
                        <div class="box-border box-padding-sm text-center">
        ...
        <div class="container">
            <div class="row section-title">
                ...
                <div class="col-12 col-md-4 offset-md-1">
                    ...
                    <h2 class="h1 text-white wow animate__animated animate__fadeIn animate__fast">Danilo Dias</h2>
                    ...
                    <ul>
                        <li class="text-white h5 my-2 wow animate__animated animate__fadeInUp">Ex-Broker de tesouraria</li>
                        <li class="text-white h5 my-2 wow animate__animated animate__fadeInUp">Mais de 14 anos de experiência no mercado financeiro</li>
                        <li class="text-white h5 my-2 wow animate__animated animate__fadeInUp">Mais de 1000 alunos em formação</li>
                    </ul>
...
<!-- FAQ section -->
    <section class="section-default section-faq bg-dark">
        <div class="gradient-radial"></div>
        <div class="container">
            <div class="row section-title">
