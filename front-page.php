...
<!-- Form section 2 -->
    <section class="section-default section-form">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-12 col-md-4 offset-md-1 wow animate__animated animate__fadeIn">
                    <span class="subtitle">Cadastre-se agora</span>
                    <h2 class="h1 text-white">Está pronto para mudar toda sua <span class="gradient-text">vida financeira</span>?</h2>
                    <p class="mt-4">Ainda está com dúvidas?</p>
                    <a target="_blank" href="<?php the_field('link_wpp','option'); ?>" class="btn underline">
        ...
        <div class="container">
            <div class="row section-title">
                ...
                <div class="col-12 col-md-4 offset-md-1">
                    ...
                    <ul>
                        <li class="text-white h4 my-2 wow animate__animated animate__fadeInUp animate__delay-2s">Ex-Broker de tesouraria</li>
                        <li class="text-white h4 my-2 wow animate__animated animate__fadeInUp animate__delay-3s">Mais de 14 anos de experiência no mercado financeiro</li>
                        <li class="text-white h4 my-2 wow animate__animated animate__fadeInUp animate__delay-4s">Mais de 1000 alunos em formação</li>
                    </ul>
                    <div class="d-flex mt-5 align-items-center grid-gap mt-4 wow animate__animated animate__fadeInUp animate__delay-5s">
                    ...
                    <div class="accordion" id="accordionFaq">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                O que é HFT e por que é relevante para mim?
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFaq">
                                <div class="accordion-body">
                                    <p>O HFT, ou High-Frequency Trading, é um estilo de negociação que envolve a execução de um grande volume de transações em um curto período de tempo, aproveitando pequenas discrepâncias nos preços dos ativos. Esta mentoria é relevante para traders e investidores que desejam aprender estratégias avançadas de negociação e capitalizar sobre as oportunidades oferecidas pelo HFT.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                Quais são os pré-requisitos para participar da mentoria?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                O que vou aprender durante a mentoria?
                                </button>
                            </h2>
