...
function hacking(){
	...
	function dibujar(){
		contexto.fillStyle="rgba(0,0,0,0.01)";//Damos el color que tendra el recuadro en el que estara la animacion. en este caso sera transparente 0.05
		...
		contexto.fillStyle= "#00d8d8";//Color de las letras
		contexto.font= letraTam+"px digital-8";//Tamaño de la letra
	...
	setInterval(dibujar,80);//velocidad a la que se ejecuta la funcion en milisegundos
